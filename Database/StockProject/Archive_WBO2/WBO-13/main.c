...
*/
#define LAMBDA_MIN	50UL// set to desired value for 0v output (Lambda*100)
#define LAMBDA_MAX 500UL//set to desired value for 5v output	(Lambda*100)
...
calculated = (calculated/3) + 116;//116 is zero current. 
