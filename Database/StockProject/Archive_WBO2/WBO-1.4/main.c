...
const uint8_t  out_volts[] PROGMEM= //up to 1024 values. 
{
...
1,1,1,1,2,2,2,2,2,2,2,2,3,3,3,3,//and so on.  this table will have 1024 values.
};
...
//	charspot = put_in_string(DC_val,'d',charspot);//puts data in big string
	...
	zero_to_5_WB = pgm_read_byte(&out_volts[pump]);//get 0-5 DAC value out of lookup table	
